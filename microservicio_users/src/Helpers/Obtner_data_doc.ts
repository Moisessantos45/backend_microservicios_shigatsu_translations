import { UserWithoutPassword, userData, MyTypes } from "../Types/types";
...
const transformToUserWithoutPassword = (data: MyTypes): UserWithoutPassword => {
  const { ...rest } = data as userData;
  return { ...rest };
};
...
export { extraerData, transformData, transformToUserWithoutPassword };
